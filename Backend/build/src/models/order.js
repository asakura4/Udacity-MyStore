        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("unable create order " + o.user_id + " : " + err_1);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.findCurrentOrderByUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable find order " + id + " : " + err_2 + " ");
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.findCompletedOrderByUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable find order " + id + " : " + err_3 + " ");
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.completeOrder = function (user_id, order_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("unable find order " + order_id + " : " + err_4 + " ");
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        err_6 = _a.sent();
                        throw new Error("Could not add product " + product_id + " to order " + order_id + ": " + err_6);
