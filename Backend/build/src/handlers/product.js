    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, store.show(req.params._id)];
            case 1:
                product = _a.sent();
                res.json(product);
                return [2 /*return*/];
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, decode, prod, newProd, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
                    ...
                    decode = jsonwebtoken_1.default.verify(token, token_secret);
                }
                catch (err) {
                    res.status(401);
                    console.log(err);
...
var getProductByCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.getProductByCategory(req.params.category)];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
